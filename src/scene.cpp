...
Scene loadScene(SceneType type, const std::filesystem::path& dataDir)
{
    ...
    case Spheres: {
        ...
        scene.lights.push_back(PointLight { glm::vec3(3, 0, 3), glm::vec3(15) });
    } break;
    case Custom: {
        // === Replace custom.obj by your own 3D model (or call your 3D model custom.obj) ===
        auto subMeshes = loadMesh(dataDir / "two-triangle.obj");
        //subMeshes[0].material.kd = glm::vec3(1.0f); //by me
